...
import { Icon, Form, Card } from 'antd';
import { InputF,RadioH, DatePickerH } from '@/components/FormMark';
...
class UserInfo extends React.Component {
  ...
  setEditInfo = (userInfo = {}) => {
    ...
    // 设置主表信息
    this.form.setFieldsValue(lodash.pick(master, this.formField));
    // // 设置用户扩展信息
      ...
      },
      {
        ...
        cellEditorParams: {
          ...
          config: {
            ...
            modalKey: 'entityName',
            onSearchBefore: api => {
              return { usingFlag: api.data.usingFlag || '1' ,unitId: api.data.reimUnitId || '-1' };
            }, // 查询条件
            onOk: (idArr, rowArr, api) => {
              // 确认赋值
      ...
      },
      {
        ...
        cellEditorParams: {
          ...
          config: {
            ...
            onSearchBefore: api => {
              return { companyId: api.data.unitId || '-1' };
            }, // 查询条件
            onOk: (idArr, rowArr, api) => {
              // 确认赋值
